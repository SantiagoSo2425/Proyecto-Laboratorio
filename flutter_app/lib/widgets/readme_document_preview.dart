    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _InfoTile(icon: Icons.public_outlined, title: 'OSF', value: draft.osfUrl.isEmpty ? 'Sin definir' : draft.osfUrl),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _SectionCard(
            title: 'OSF',
            subtitle: 'Enlace de referencia del proyecto',
            palette: palette,
            child: Text(
              draft.osfUrl.isEmpty ? 'Sin enlace a OSF' : draft.osfUrl,
              style: _bodyStyle(context, palette),
            ),
          ),
          const SizedBox(height: 16),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _InlineField(label: 'Documento', value: participant.document, palette: palette),
          const SizedBox(height: 8),
          _InlineField(
            label: 'Instituciones',
            value: participant.institutions.isEmpty ? '' : participant.institutions.join(', '),
            palette: palette,
          ),
          const SizedBox(height: 8),
